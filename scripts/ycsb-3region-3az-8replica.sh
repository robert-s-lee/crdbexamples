...
roachprod run $f:1 -- "PATH=~/:\$PATH;. ~/crdb.sh; . ~/ycsb.sh; _crdb_num_replicas -r=${replicas}; YCSB=ycsb-jdbc-binding-0.16.0-SNAPSHOT; _ycsb_replica=${replicas} _ycsb_init; _ycsb_part; _ycsb_lease"
