...
roachprod run $f -- 'curl -O --location https://github.com/robert-s-lee/crdbexamples/raw/${branch}/scripts/crdb.sh; curl -O --location https://github.com/robert-s-lee/crdbexamples/raw/${branch}/scripts/ycsb.sh; chmod a+x *.sh'
...
roachprod run $f:1 -- "PATH=~/:\$PATH;. ~/crdb.sh; _crdb_replicas=${_crdb_replicas} _crdb_num_replicas;_crdb_maps_gcp; . ~/ycsb.sh; YCSB=ycsb-jdbc-binding-0.16.0-SNAPSHOT; _ycsb_replicas=${_ycsb_replicas} _ycsb_init; _ycsb_part; _ycsb_lease"
