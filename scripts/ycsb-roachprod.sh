...
roachprod run $f -- 'curl -O --location https://raw.githubusercontent.com/robert-s-lee/distro/master/ycsb-jdbc-binding-0.18.0-SNAPSHOT.tar.gz; tar xfvz ycsb-jdbc-binding-0.18.0-SNAPSHOT.tar.gz'
roachprod run $f -- 'curl -O --location  https://jdbc.postgresql.org/download/postgresql-42.2.4.jar; mv postgresql-42.2.4.jar ycsb-jdbc-binding-0.18.0-SNAPSHOT/lib/.'
roachprod run $f -- 'curl -O --location  https://dev.mysql.com/get/Downloads/Connector-J/mysql-connector-java-8.0.17.tar.gz; gzip -dc mysql-connector-java-8.0.17.tar.gz | tar -xvf -; mv mysql-connector-java-8.0.17/mysql-connector-java-8.0.17.jar ycsb-jdbc-binding-0.18.0-SNAPSHOT/lib/.'
...
roachprod run $f:1 -- "PATH=~/:\$PATH;. ~/ycsb.sh; . ~/crdb.sh; YCSB=ycsb-jdbc-binding-0.18.0-SNAPSHOT; _ycsb_insertcount=${_ycsb_insertcount} _ycsb_operationcount=500000 _ycsb_node=\`_ycsb_nodeid\`; _ycsb_port=26257 _ycsb_threads=1 _ycsb run a";

roachprod run $f:1 -- "PATH=~/:\$PATH;. ~/ycsb.sh; . ~/crdb.sh; YCSB=ycsb-jdbc-binding-0.18.0-SNAPSHOT; _ycsb_insertcount=${_ycsb_insertcount} _ycsb_operationcount=500000 _ycsb_node=\`_ycsb_nodeid_alt\`; _ycsb_port=26257 _ycsb_threads=1 _ycsb_dbdialect=jdbc:cockroach _ycsb run a";
